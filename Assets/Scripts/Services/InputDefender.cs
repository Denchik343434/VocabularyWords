...
//класс с методами защиты пользовательского ввода от недопустимых символов
public class InputDefender
{
    ...
    //очистка строки для использования как имя файла
    ...
    //очистка строки от символов ломающих JSON
    ...
    //полная очистка строки для имени файла и JSON
